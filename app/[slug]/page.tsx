    ...
    <>
      ...
      <main>
        <section className="relative isolate overflow-hidden bg-slate-950 text-white">
          <Image src="/assets/roof-1.webp" alt={page.title} fill priority sizes="100vw" className="object-cover opacity-35" />
          ...
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_0.8fr]">
            <div className="grid gap-6">
              ...
              <article className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
                <h2 className="text-2xl font-black text-slate-950">Why Choose D.R.F. Builders RI?</h2>
                <p className="mt-3 leading-7 text-slate-700">
                  D.R.F. Builders RI is a Cranston-based roofing company serving Rhode Island with roof repair, roof replacement,
                  roof inspections, gutter cleaning, roof maintenance, residential roofing, and commercial roofing. The company is
                  owner-led by Danny Fusco and focused on honest communication, dependable work, and clean job sites.
                </p>
              </article>
            </div>
            ...
            <aside className="h-fit rounded-lg bg-slate-950 p-6 text-white shadow-xl">
              ...
              <h2 className="text-2xl font-black">Free Roofing Estimate</h2>
        ...
        <section id="contact" className="bg-white px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              ...
              <h2 className="text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">Request a Free Estimate</h2>
